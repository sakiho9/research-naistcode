        ...
        if profile_element:
            ...
            for info in profile_info:
                ...
                if term == "性別":
                    ...
                    birth_date = datetime.strptime(value, "%年%m月%d日") if value != "非公開" else None
...
# 実行
ranking_url = "https://blogger.ameba.jp/genres/diet/blogs/ranking?rank=197&amebaId=atdjapmtmtat"
