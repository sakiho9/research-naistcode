...
# 韓国語モデルのパス
MODEL_PATH = "/home/is/sakiho-k/research/notebooks/eating_disorder/multilingual/model/japanese_model/checkpoint-4640"
...
def main():
    ...
    # テストデータの前処理
    dataset = preprocess_test_data(test_data_k)
    ...
    # 結果の出力
    print("Evaluation Metrics on Korean Test Data:")
